...
const MyHelpDetailsPending = ({ route, navigation }: any) => {
  ...
  return <ScrollView>
    <View style={{ ...themeStyles.card, marginHorizontal: 20 }}>
      <Text>Twoje zgłoszenie zostało przyjęte do systemu i oczekuje na weryfikację.</Text>
    </View>
    <View style={{ ...themeStyles.card, marginHorizontal: 20, marginTop: 0 }}>
